...
with sftp.file("/var/www/courtsideedge/server/nba-prop-model/scripts/check_cols.py", "w") as f:
    f.write(script_content)
sftp.close()

print("Running check...")
cmd_run = "python3 /var/www/courtsideedge/server/nba-prop-model/scripts/check_cols.py"
