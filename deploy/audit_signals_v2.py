...
print(f"Using DB Connection") # Hiding full URL for security logs

# Construct psql command safely
...
# Check the last 100 projections
full_cmd_logs = f"""{psql_cmd} -t -c "SELECT signals FROM projection_logs WHERE created_at > NOW() - INTERVAL '48 hours' ORDER BY created_at DESC LIMIT 100;" """
...
print("Signal Presence Frequency (How often is this signal generated?):")
