...
stdin, stdout, stderr = client.exec_command("ls /var/www/courtsideedge/server/nba-prop-model/scripts/", timeout=10)
print("Scripts:", stdout.read().decode().strip())

# Check if venv exists
stdin, stdout, stderr = client.exec_command("ls /var/www/courtsideedge/server/nba-prop-model/venv/bin/python", timeout=10)
