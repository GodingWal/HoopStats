...
"""
    ...
    run_command(client, f"cat > /var/www/hoopstats/test.cjs << 'EOF'\n{test_script}\nEOF")
    
    # Run with node
    success = run_command(client, "cd /var/www/hoopstats && node test.cjs")
    ...
    if success:
        ...
        import time
        time.sleep(5)
        run_command(client, "tail -n 20 /root/.pm2/logs/hoopstats-out.log")
