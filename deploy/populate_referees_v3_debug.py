...
print("Starting synchronous debug population...")
                ...
                for gid in game_ids:
                    ...
                    try:
                        ...
                        if meta.empty:
                            ...
                            continue
                        if officials.empty:
                            print("      Officials empty (V3 returned no refs)")
                            continue
                        ...
                        for _, row in officials.iterrows():
                            # Fix: dataframe columns might be camelCase
...
remote_path = "/var/www/courtsideedge/server/nba-prop-model/scripts/populate_referees_v3_debug.py"
