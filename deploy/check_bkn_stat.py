...
cmd_check = f"""{psql_cmd} -c "SELECT team_abbr, opp_pts_allowed, opp_reb_allowed FROM team_defense WHERE team_abbr IN ('BKN', 'BOS', 'WAS') ORDER BY opp_pts_allowed DESC;" """
